...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <p className="p">Last updated: August 26, 2023</p>
      <p className="p">
      ...
      <ul className="ul">
        ...
        <li className="li">
          <p className="p">
            <strong>Application</strong> refers to SAGIP, the software program
        ...
        <li className="li">
          <p className="p">
            ...
            this Agreement) refers to Malolos City Disaster Risk Reduction
            Management Office, Malolos, Bulacan.
          </p>
        </li>
        <li className="li">
          <p className="p">
      ...
      <ul className="ul">
        ...
        <li className="li">
          {/* <p className="p"> */}Address, State, Province, ZIP/Postal code,
          City{/* </p> */}
        </li>
        <li className="li">
          {/* <p className="p"> */}Usage Data{/* </p> */}
        </li>
      </ul>
      ...
      <h3 className="h3">Information Collected while Using the Application</h3>
      <p className="p">
      ...
      <ul className="ul">
        <li className="li">
          {/* <p className="p"> */}Information regarding your location
          {/* </p> */}
        </li>
        <li className="li">
          {/*  <p className="p"> */}
      ...
      <ul className="ul">
        <li className="li">By email: sagip.cityofmalolos.drrmo@gmail.com</li>
      </ul>
    </>
  );
};
