...
const TermsAndCondition = () => {
  return (
    <div>
      ...
      <h3 className="h3">AGREEMENT TO OUR LEGAL TERMS</h3>

      <p className="p">
        We are Malolos City Disaster Risk Reduction Management Office, doing
        business as Malolos CDRRMO ("Company," "we," "us," "our"), a company
        registered in the Philippines at CDRRMO Operation Center, Bulihan, City
        of Malolos, Bulacan, Malolos City, Bulacan 3000.
      </p>

      <p className="p">
        We operate the mobile application SAGIP (the "App"), as well as any
        other related products and services that refer or link to these legal
        terms (the "Legal Terms") (collectively, the "Services").
      </p>

      <p className="p">
        SAGIP: Safety Assistance with Geo-tracking Integration Program for
        Malolos City Disaster Risk Reduction Management Office (CDRRMO) to
        strengthen the disaster preparedness of Malolos' residents and improve
        the department's emergency response.
      </p>

      <p className="p">
        You can contact us by phone at +63-44-931-8888 (loc. 2106), email at
        <a className="a" href="mailto:sagip.cityofmalolos.drrmo@gmail.com">
          sagip.cityofmalolos.drrmo@gmail.com
        </a>
        , or by mail to CDRRMO Operation Center, Bulihan, City of Malolos,
        Bulacan, Malolos City, Bulacan 3000, Philippines.
      </p>

      <p className="p">
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and Malolos
        City Disaster Risk Reduction Management Office, concerning your access
      ...
      <ol className="ol">
        ...
        <li className="li">
          <a className="a" href="#section2">
            INTELLECTUAL PROPERTY RIGHTS
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section3">
            USER REPRESENTATIONS
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section4">
            USER REGISTRATION
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section5">
            PROHIBITED ACTIVITIES
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section6">
            USER GENERATED CONTRIBUTIONS
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section7">
            CONTRIBUTION LICENSE
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section8">
            MOBILE APPLICATION LICENSE
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section9">
            SERVICES MANAGEMENT
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section10">
            PRIVACY POLICY
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section11">
            COPYRIGHT INFRINGEMENTS
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section12">
            TERM AND TERMINATION
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section13">
            MODIFICATIONS AND INTERRUPTIONS
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section14">
            GOVERNING LAW
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section15">
            DISPUTE RESOLUTION
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section16">
            CORRECTIONS
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section17">
            DISCLAIMER
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section18">
            LIMITATIONS OF LIABILITY
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section19">
            INDEMNIFICATION
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section20">
            USER DATA
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section21">
            ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section22">
            MISCELLANEOUS
          </a>
        </li>
        <li className="li">
          <a className="a" href="#section23">
            CONTACT US
          </a>
        </li>
      </ol>

      <h2 className="h2" id="section1">
        1. OUR SERVICES
      </h2>
      ...
      <ul className="ul">
        <li className="li">
          {/* <p className="p"> */}access the Services; and{/* </p> */}
        </li>
        <li className="li">
          {/* <p className="p"> */}
      ...
      <p className="p">
        ...
        address your request to: sagip.cityofmalolos.drrmo@gmail.com. If we ever
      ...
      <p className="p">
        ...
        <a className="a" href="setion11">
          "COPYRIGHT INFRINGEMENTS"
        </a>{" "}
        section below.
      </p>

      <h2 className="h2" id="section3">
      ...
      <p className="p">As a user of the Services, you agree not to:</p>
      <ul className="ul">
        <li className="li">
          <p className="p">
      ...
      <p className="p">
        ...
        Services are hosted in the Philippines. If you access the Services from
        ...
        laws in the Philippines, then through your continued use of the
        Services, you are transferring your data to the Philippines, and you
        expressly consent to have your data transferred to and processed in the
        Philippines.
      </p>
      <h2 className="h2" id="section11">
      ...
      <h2 className="h2" id="section14">
        14. GOVERNING LAW
      </h2>
      <p className="p">
        These Legal Terms shall be governed by and defined following the laws of
        the Philippines. Malolos City Disaster Risk Reduction Management Office
        and yourself irrevocably consent that the courts of the Philippines
        shall have exclusive jurisdiction to resolve any dispute which may arise
        in connection with these Legal Terms.
      </p>
      <h2 className="h2" id="section15">
      ...
      <p className="p">
        ...
        jurisdiction of the Philippines courts. Malolos City Disaster Risk
        Reduction Management Office shall also maintain the right to bring
      ...
      <p className="p">
        <strong>
          ...
          <br />
          CDRRMO Operation Center, Bulihan, City of Malolos, Bulacan
          <br />
          Malolos City, Bulacan 3000
          <br />
          Philippines
          <br />
          Phone: +63-44-931-8888 (loc. 2106)
          <br />
          sagip.cityofmalolos.drrmo@gmail.com
        </strong>
      </p>
