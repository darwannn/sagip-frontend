...
const EmergencyHotlineList: React.FC<TProps> = ({
  title,
  logo,
  contactNumber,
  isPrimary,
  ...
  return (
    <div
      className={`flex items-center rounded-lg py-4 px-5 font-bold cursor-pointer ${
        isPrimary ? "text-white" : "bg-gray-300 text-gray-800"
      }`}
      style={
        isPrimary
          ? {
              background: "linear-gradient(90deg, #C92A2A 0%, #293B95 100%)",
            }
          : {}
      }
      onClick={() => {
...
export default EmergencyHotlineList;
