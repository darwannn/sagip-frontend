  ...
  return (
    <div className="min-w-[300px] z-10 border-r bg-white flex flex-col p-5 overflow-y-scroll ">
      ...
      <nav className="grow py-5 flex flex-col gap-1">
        {["super-admin", "admin", "dispatcher"].includes(
          ...
          <NavLink
            className={({ isActive }) =>
              ...
              } w-full hover:bg-blue-100 p-2 rounded`
            }
            to={"/admin"}
            end
          >
        ...
        {["super-admin"].includes(decodedToken.userType) && (
          <NavLink
            className={({ isActive }) =>
              `${
                isActive ? "bg-primary-100 " : ""
        ...
        {["super-admin", "admin"].includes(decodedToken.userType) && (
          <NavLink
            className={({ isActive }) =>
              `${
                isActive ? "bg-primary-100 " : ""
      ...
      <div className="flex flex-col mt-5 gap-1">
        <div
          className="w-full hover:bg-blue-100 p-2 rounded cursor-pointer"
        ...
        <button
          className="w-full hover:bg-blue-100 p-2 rounded"
          onClick={() => logout()}
        >
          <div className="flex items-center gap-4 ">
            <span className="text-[18px] text-gray-600">
